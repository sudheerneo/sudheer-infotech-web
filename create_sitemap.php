...
//////////////////////////////////// Options ////////////////////////////////////
$url = "http://sudheerinfo.com/"; //The Url of the site - the last '/' is needed

$root_dir = '/opt/lampp/htdocs/'; //Where the root of the site is with relation to this file.
...
$sitemap_file = 'sitemaps.xml'; 

// Stuff to be ignored...
//Ignore the file/folder if these words appear in the name
$always_ignore = array(
	'local_common.php','images', 'assets', 'Instamojo','jobsBackendapi', 'logs', 'ruff.txt', 'seopanel.php'
);

//These files will not be linked in the sitemap.
$ignore_files = array(
	'404.php','error.php','configuration.php','include.inc', 'masterTheme.php', 'create_sitemap.php'
);

//The script will not enter these folders
$ignore_folders = array(
	'Waste','php_uploads','images','includes','lib','js','css','styles','system','stats','CVS','.svn', 'assets', 'Instamojo','jobsBackendapi', 'logs'
);
...
<form action="create_sitemap" method="post">
