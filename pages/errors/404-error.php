...
<body class="is-preload">
	<!-- Header -->
	<section id="header">
		<header> <span class="image avatar"><img id="profileAvtar" src="images/sudheer.png" alt="sudheer" /></span>
